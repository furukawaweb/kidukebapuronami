...
if(isset($_SESSION['cart'])==true)//変数に何か入っていればtrue
{
    $cart=$_SESSION['cart'];
    $kazu=$_SESSION['kazu'];
    $max=count($cart);
...
{
    $sql = 'SELECT code,name,price,gazou FROM mst_product WHERE code=?';//mst_productにあるcodeが?のcode,name,price,gazouカラムのデータをください
